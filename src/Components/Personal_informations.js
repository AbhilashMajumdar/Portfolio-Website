    ...
    return (
        <>
            <div class="container-fluid">
                ...
                <div class="row">
                    <div class="col-md-12 col-12 my-4 det per-des">
                        <div className="perinfo mt-3 mx-4">
                            <h4><b>Father's Name :- </b></h4> 
                            <h5 className="data">Late Dipak Ranjan Majumdar</h5>
                        </div>
                        <div className="perinfo mx-4">
                        ...
                        </div><div className="perinfo mx-4">
